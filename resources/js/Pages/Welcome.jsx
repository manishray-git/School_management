        ...
        <>
            ...
            <div className="bg-gray-50  text-black/50 dark:bg-black dark:text-white/50  h-screen">
                <div className="p-10 flex justify-center ">
                    ...
                    <h1 className="text-center text-4xl text-black self-center">
                    ...
                    <div className=" flex  space-x-48 w-full ">
                        <div className="container w-2/5">
                            ...
                            >
                                ...
                                <g>
                                    <path
                                        id="uuid-bb35f39c-94aa-41c4-b5d9-34ca9a9e88f1-331"
                                    ...
                                    />
                                    <path
                                        id="uuid-97233535-ec91-4408-928f-bf1e5273ca3e-332"
                        ...
                        <div className="container border p-4 h-fit mt-10 rounded-md w-3/5 flex flex-col">
                            <h1 className="text-blue-600 font-semibold text-xl">
                                Welcome to Eschool
                            </h1>
                            <form onSubmit={submit} className="flex flex-col space-y-7 mt-4 ">
                            ...
                            <div className="social_media flex justify-center space-x-3">
                                <Link href={route('sociallogin','facebook')}>
                                <div className="self-center cursor-pointer">
                                <BiLogoFacebookCircle className="text-3xl "  />
                                </div>
                                </Link>

                                <Link href={route('googlelogin')}>
